...
const VALID_ACTINIUM_MAINNET_LN =
  ''
const VALID_ACTINIUM_TESTNET_LN =
  ''
...
describe('Crypto.isLn', () => {
  ...
  describe('Actinium', () => {
    describe('Mainnet', () => {
      it('should pass with a valid invoice ', () => {
        expect(isLn(VALID_ACTINIUM_MAINNET_LN, 'actinium', 'mainnet')).toBeTruthy()
      })
      it('should fail with an invalid invoice ', () => {
        expect(isLn(VALID_ACTINIUM_TESTNET_LN, 'actinium', 'mainnet')).toBeFalsy()
      })
    })
    describe('Testnet', () => {
      it('should pass with a valid invoice', () => {
        expect(isLn(VALID_ACTINIUM_TESTNET_LN, 'actinium', 'testnet')).toBeTruthy()
      })
      it('should fail with an invalid invoice ', () => {
        expect(isLn(VALID_ACTINIUM_MAINNET_LN, 'actinium', 'testnet')).toBeFalsy()
      })
    })
  })
})
...
const VALID_ACTINIUM_MAINNET = 'LW9Q7QU8dgaGBerVkxbmVfurr2E1cFudrn'
const VALID_ACTINIUM_TESTNET = 'Qbssgb8huSkT8adTGoyoSZpHrbcUEz2vnY'
...
describe('Crypto.isOnchain', () => {
  ...
  describe('Actinium', () => {
    describe('Mainnet', () => {
      it('should pass with a valid address ', () => {
        expect(isOnchain(VALID_ACTINIUM_MAINNET, 'actinium', 'mainnet')).toBeTruthy()
      })
      it('should fail with an invalid address ', () => {
        expect(isOnchain(VALID_ACTINIUM_TESTNET, 'actinium', 'mainnet')).toBeFalsy()
      })
    })
    describe('Testnet', () => {
      it('should pass with a valid address', () => {
        expect(isOnchain(VALID_ACTINIUM_TESTNET, 'actinium', 'testnet')).toBeTruthy()
      })
      it('should fail with an invalid address ', () => {
        expect(isOnchain(VALID_ACTINIUM_MAINNET, 'actinium', 'testnet')).toBeFalsy()
      })
    })
  })
})
